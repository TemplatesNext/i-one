...
if ( ! class_exists( 'RWMB_Media_Field' ) )
{
	class RWMB_Media_Field extends RWMB_Field
	{
		...
		{
			$i18n_add            = apply_filters( 'rwmb_media_add_string', _x( '+ Add Media', 'media', 'i-one' ) );
			$i18n_remove         = apply_filters( 'rwmb_media_remove_string', _x( 'Remove', 'media', 'i-one' ) );
			$i18n_edit           = apply_filters( 'rwmb_media_edit_string', _x( 'Edit', 'media', 'i-one' ) );
			$i18n_view           = apply_filters( 'rwmb_media_view_string', _x( 'View', 'media', 'i-one' ) );
			$i18n_single_files   = apply_filters( 'rwmb_media_single_files_string', _x( ' file', 'media', 'i-one' ) );
			$i18n_multiple_files = apply_filters( 'rwmb_media_multiple_files_string', _x( ' files', 'media', 'i-one' ) );
			$i18n_title          = _x( 'No Title', 'media', 'i-one' );
			?>
